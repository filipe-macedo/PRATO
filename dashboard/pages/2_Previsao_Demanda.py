...
if not _api_ok:
    st.info(
        "⚠️ **Modo Demo** — a previsão é estimada com base na média histórica "
        "do produto e turno selecionados, com variação determinística."
    )
...
if not df_prev.empty:
    ...
    st.info(
        "Sem arquivo de previsões em lote. "
        "Execute `make pipeline` para gerá-lo, ou use a consulta individual acima."
    )
