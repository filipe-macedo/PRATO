...
imgs = [
    ...
    (_ROOT / "outputs" / "avaliacao" / "curva_cumulativa_erro.png",   "Curva Cumulativa de Erros"),
]
...
for col, (caminho, titulo) in zip(cols, imgs):
    if caminho.exists():
        ...
        col.info(f"Execute `make pipeline` para gerar o gráfico '{titulo}'.")
